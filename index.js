...
const { theMuppetMovie: { song2 } } = nestedMuppet.album
const { theMuppetMovie: { song4 } } = nestedMuppet.album
let { nestedJob: nestedJob } = nestedMuppet
let { 'nestedPartner': nestedPartner } = nestedMuppet
console.log(song2)